...
import (
	...
	// "gitlab.pg.innopolis.university/f.markin/fah/profileService/internal/domain/courseInstance/e"
...
func (s *Service) GetInstancesByInstitutes(ctx context.Context, academicYearIDs []int64) ([]int64, error) {
