...
func (r *CourseInstanceRepo) GetInstanceByInstituteID(ctx context.Context, instituteID int64) (*courseInstance.CourseInstance, error) {
...
func (r *CourseInstanceRepo) GetInstanceByAcademicYearID(ctx context.Context, academicYearID int64) (*courseInstance.CourseInstance, error) {
